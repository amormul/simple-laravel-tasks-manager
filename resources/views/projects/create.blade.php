                    ...
                    <div class="card-body p-5 position-relative">
                        <form action="{{ route('projects.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" style="background: rgba(255, 255, 255, 0.1); color: #fff; border: 2px solid rgba(255, 255, 255, 0.2);">{{ old('description') }}</textarea>
                            </div>
